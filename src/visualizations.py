...
def create_top_genres_pie_chart(genre_data):
    # Data to plot
    ...
    plt.savefig("./static/genres_pie_chart.png", transparent=True)
    plt.clf()

def create_live_vs_studio_pie_chart(live_data):
    ...
    plt.savefig("./static/live_pie_chart.png", transparent=True)
    plt.clf()


def create_acoustic_vs_non_acoustic_pie_chart(acoustic_data):
    ...
    plt.savefig("./static/acoustic_pie_chart.png", transparent=True)
    plt.clf()